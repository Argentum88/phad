 ...
 */
namespace App\Modules\Backend\Library\Paginator {
    ...
    class Pager implements \IteratorAggregate, \Countable
    {
         ...
         *
         * @return \App\Modules\Backend\Library\Paginator\Layout
         * @throws \RuntimeException
         */
        public function getLayout()
        {
            if (!array_key_exists('rangeClass', $this->options)) {
                $this->options['rangeClass'] = 'App\Modules\Backend\Library\Paginator\Pager\Range\Sliding';
            }
            ...
            if (!array_key_exists('layoutClass', $this->options)) {
                $this->options['layoutClass'] = 'App\Modules\Backend\Library\Paginator\Pager\Layout';
            }
