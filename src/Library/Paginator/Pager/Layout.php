 ...
 */
namespace App\Modules\Backend\Library\Paginator\Pager {

    use App\Modules\Backend\Library\Paginator\Pager;
    use App\Modules\Backend\Library\Paginator\Pager\Range;
    ...
    class Layout
    {
         ...
         * Pager object.
         *
         * @var \App\Modules\Backend\Library\Paginator\Pager
         */
         ...
         * Ranges generator.
         *
         * @var $range \App\Modules\Backend\Library\Paginator\Pager\Range
         */
